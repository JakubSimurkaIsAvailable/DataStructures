...
namespace ds::amt {
    ...
    {
		// TODO 03
		return this->size() > 0 ? &this->getMemoryManager()->getBlockAt(this->size() - 1) : nullptr; //BlockType&
	...
	{
		// TODO 03
		size_t index = this->indexOfNext(this->getMemoryManager()->calculateIndex(block)) + 2;
		this->getMemoryManager()->releaseMemoryAt(index);
	}
	...
	{
		// TODO 03
		return currentIndex - 1 > 0 ? currentIndex - 1 : INVALID_INDEX;
	}
